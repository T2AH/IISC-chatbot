"""
Retriever module for fetching relevant context from databases
"""
...
class HybridRetriever:
    """Hybrid retriever combining vector search and knowledge graph queries"""
    ...
    def __init__(self, chromadb_client: ChromaDBClient = None, neo4j_client: Neo4jClient = None):
        ...
        # Get configuration
        self.top_k_vectors = config.get('rag', 'retrieval', 'top_k_vectors', default=100)  # Increased from 50
    ...
    'diarcoe': [
        ...
        # URL patterns for smart filtering
        self.url_patterns = {
