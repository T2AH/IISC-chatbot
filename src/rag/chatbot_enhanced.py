...
class EnhancedRAGChatbot:
    ...
    def __init__(self, retriever: EnhancedHybridRetriever = None, 
                 reranker: EnhancedReranker = None,
                 debug: bool = False):
        """
        ...
        """
        self.retriever = retriever or EnhancedHybridRetriever()
        self.reranker = reranker or EnhancedReranker()
        self.debug = debug
